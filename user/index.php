...
?>
  ...
  <head>
    ...
    <link rel="icon" href="../build/images/sditlogo.ico">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php?page=dashboard" class="site_title"><i class="fa fa-university"></i><span> SIMPEG</span></a>
            </div>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                if ($jabatanpegawai == 'OPERATOR' || $jabatanpegawai == 'SEKRETARIS' || $jabatanpegawai == 'KETUA' || $jabatanpegawai == 'KEPALA TU' || $jabatanpegawai == 'KEPALA KOMITE' || $jabatanpegawai == 'WAKA KURIKULUM' || $jabatanpegawai == 'BENDAHARA' || $jabatanpegawai == 'KEPALA SAPRAS' || $jabatanpegawai == 'WAKA KESISWAAAN') {
                ?>
                  ...
                  <li role="presentation" class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                      ...
                      } elseif ($jabatanpegawai == 'OPERATOR' || $jabatanpegawai == 'SEKRETARIS') {
        ...
        <div class="right_col" role="main">
          ...
          if (isset($_GET['page'])) {
            switch ($_GET['page']) {
              ...
              case 'approve_cuti':
                include 'approve_cuti.php';
                break;
              case 'approval_cuti':
                include 'approve_update.php';
                break;
