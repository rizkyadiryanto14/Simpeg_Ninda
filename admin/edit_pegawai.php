...
$query = "UPDATE pegawai SET nama_pegawai='$nama', id_jabatan='$jabatanpegawai', id_golongan='$golpegawai', id_pendidikan='$pendidikan', jenis_kelamin='$jenis_kelamin', TTL='$TTL', agama='$agama',tahun_masuk='$tahun_masuk', tahun_keluar='$tahun_keluar' WHERE nip='$nip'";
