...
<div class="row top_tiles">
  <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <h3>Users</h3>
      <p>Jumlah users yang memakai aplikasi SIMPEG</p>
      <hr>
...
<div class="row top_tiles">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pegawai <small>Daftar Pegawai SDIT Insan Qur'ani Sumbawa</small></h2>
...
<div class="row">
  <div class="ccol-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content text-center">
        <h1><i class="fa fa-university"></i> SIMPEG</h1>
        <p>Sistem Informasi Pegawai</p>
        <p></p>
        <p>© <?= date('Y'); ?> SDIT Insan Qur'ani Sumbawa</p>
      </div>
    </div>
  </div>
</div>